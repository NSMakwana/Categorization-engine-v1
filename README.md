...
Instead, it builds evidence for all plausible categories, ranks candidate hypotheses, applies
 confidence adjustments, records conflicts, and exposes alternatives.
